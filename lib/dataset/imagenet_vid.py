...
from utils.display_util import Processbar
...
class ImageNetVID(IMDB):
    def __init__(self, image_set, root_path, dataset_path, result_path=None):
        ...
        self.bar = Processbar(max_process=self.num_images)
