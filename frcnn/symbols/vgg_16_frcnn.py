...
class vgg_16_frcnn(Symbol):
    ...
    def get_rpn_feat(self, data):
        ...
        rpn_feat = vgg_layer(data, last_pool=False)
    ...
    def get_rcnn_feat(self, data):
        ...
        fc6 = mx.sym.FullyConnected(data=data, num_hidden=4096, name='fc6')
        fc6_relu = mx.sym.Activation(data=fc6, act_type='relu', name='fc6_relu')
        drop6 = mx.sym.Dropout(data=fc6_relu, p=0.5, name='drop6')
        fc7 = mx.sym.FullyConnected(data=fc6, num_hidden=4096, name='fc7')
        fc7_relu = mx.sym.Activation(data=fc7, act_type='relu', name='fc7_relu')
        drop7 = mx.sym.Dropout(data=fc7_relu, p=0.5, name='drop7')
        return drop7 
